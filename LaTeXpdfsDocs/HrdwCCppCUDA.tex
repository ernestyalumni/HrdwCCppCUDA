...
\usepackage{pdfpages}
\usepackage{tikz}
\usetikzlibrary{matrix,arrows,backgrounds, positioning, shapes}
...
Figure 10.2 of Cormen, Leiserson, Rivest, and Stein (2009) \cite{CLRS2009} shows one way to implement a queue of \textbf{at most $n-1$ elements } using an \textbf{array $Q[1\dots n]$}. 
