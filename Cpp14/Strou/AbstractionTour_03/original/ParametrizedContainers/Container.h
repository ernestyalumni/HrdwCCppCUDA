 ...
 * @brief  : Container as an abstract type, parametrized as a template.  
...
class Container
{
	public:
		...
		virtual T& operator[](const int) const = 0;	// pure virtual function
		virtual T& operator[](const std::size_t) const = 0;	// pure virtual function
...
//------------------------------------------------------------------------------
/// \brief prints out contents of Container c
//------------------------------------------------------------------------------
template<typename T>
