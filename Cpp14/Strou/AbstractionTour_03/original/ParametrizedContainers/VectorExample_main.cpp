...
int main()
{
	...
	VectorExample<double> v3 {1., 2., 3., 4., 5.};
	...
	UniqueVectorExample<double> uv3 {1., 2., 3., 4., 5.};
	...
	VectorExampleContainer<double> v_container(6);

	// VectorExampleContainerConstructsWithInitializerList
	VectorExampleContainer<double> v_container1 {0., 2., 4., 6., 8.};

	// UniqueVectorExampleContainerConstructsWithInteger
	UniqueVectorExampleContainer<double> uv_container(7);

	// UniqueVectorExampleContainerConstructsWithInitializerList
	UniqueVectorExampleContainer<double> uv_container1 {0., 2., 4., 6., 8.};

	std::cout << "\n VectorExampleIsCopyConstructible\n";
	// VectorExampleIsCopyConstructible
	VectorExample<double> v3b = v3;
	...
	UniqueVectorExample<double> uv3b = uv3;
	...
	UniqueVectorExample<double> uv4(3);
	uv4 = uv3b;
	...
	VectorExample<double> v4b = std::move(v4);
	...
	UniqueVectorExample<double> uv4b = std::move(uv4);
	...
	UniqueVectorExample<double> uv5(4);
	uv5 = std::move(uv4b);
