...
class D2 : private B0
{
  public:
    ...
    explicit D2(const double a, const double b, const std::string& id,
      const std::string& name, const int k);
  ...
  private:
    int k_;
    std::string name_;
    static constexpr const double NUM_VAL_ {128.}; // non-static data member NUM_VAL_ declared constexpr
