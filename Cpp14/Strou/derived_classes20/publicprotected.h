...
public:
    ...
    Parent() = delete; // default constructor (ctor)

    Parent(const Parent&) = default; // copy ctor
    Parent(Parent&&) = default; // move ctor
    Parent& operator=(const Parent&) = default; // copy assignment ctor
    Parent& operator=(Parent&&) = default; // move assignment ctor
...
class Child_public : public Parent
{
  public:
    ...
    Child_public(const Child_public&) = default;
    Child_public(Child_public&&) = default;
    Child_public& operator=(const Child_public&) = default;
    Child_public& operator=(Child_public&&) = default;

    ~Child_public() = default;
