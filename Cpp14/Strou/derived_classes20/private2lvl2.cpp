...
D1::D1(const double a, const double b, const std::string& id, const double num,
  const std::string& name, const int k):
  B0{a, b, id, num}, name_{name}, k_{k}
{}
...
D2::D2(const double a, const double b, const std::string& id,
  const std::string& name, const int k):
  B0{a, b, id, NUM_VAL_}, name_{name}, k_{k}
{}
