#ifndef ALGORITHMS_SORTING_STRINGS_LEAST_SIGNIFICANT_DIGIT_FIRST_H
#define ALGORITHMS_SORTING_STRINGS_LEAST_SIGNIFICANT_DIGIT_FIRST_H
...
void least_significant_digit_first_sort(
    ContainerT& a,
