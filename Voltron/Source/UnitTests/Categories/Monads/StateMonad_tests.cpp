...
using Categories::Monads::StateMonad::StateObject;
using Categories::Monads::StateMonad::StateObjectAsPair;
using Categories::Monads::StateMonad::multiplication_component;
